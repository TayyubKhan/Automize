...
class ShareWithOthersView extends StatefulWidget {
  const ShareWithOthersView({Key? key}) : super(key: key);

  @override
  State<ShareWithOthersView> createState() => _ShareWithOthersViewState();
}

class _ShareWithOthersViewState extends State<ShareWithOthersView> {
  bool show = false;
