...
class TabBarSharingView extends StatefulWidget {
  const TabBarSharingView({Key? key}) : super(key: key);

  @override
  State<TabBarSharingView> createState() => _TabBarSharingViewState();
}

class _TabBarSharingViewState extends State<TabBarSharingView> {
  bool show = false;
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                    color: greyColor, fontSize: width * 0.044),
                              ),
                              const ImageIcon(
                                  color: secondaryColor,
                                  AssetImage('assets/copy 1.png'))
                            ],
                          ),
                          SizedBox(
                            height: height * 0.007,
                          ...
                          Text(
                            'Preview',
                            style: TextStyle(
                                color: secondaryColor, fontSize: width * 0.04),
                          ),
                        ],
                      ),
                    ),
